...
red_mask_rec=cv2.bitwise_and(img,img,red_mask)

font=cv2.FONT_HERSHEY_SIMPLEX
text='Znak stop'
cv2.putText(red_mask_rec,text,(500,285),font,1,(0,255,0),2,cv2.LINE_AA)

cv2.imshow('slika meske',red_mask)
cv2.imshow('slika i natpis',red_mask_rec)
cv2.waitKey()
